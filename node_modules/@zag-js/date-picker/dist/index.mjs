...
import { DateFormatter, toZoned, toCalendarDateTime, isEqualYear, isEqualMonth, isEqualDay, CalendarDate, parseDate, isWeekend, isToday } from '@internationalized/date';
import { getDecadeRange, isDateOutsideRange, alignDate, constrainValue, getTodayDate, getPreviousSection, getNextSection, getPreviousPage, getNextPage, isDateEqual, formatSelectedDate, isNextRangeInvalid, isPreviousRangeInvalid, getEndDate, parseDateString, getAdjustedDateFn, getDateRangePreset, getWeekOfYear, getWeekDays, getMonthFormatter, getDaysInWeek, getMonthDays, getMonthNames, getYearsRange, isDateUnavailable, getDayFormatter, getUnitDuration } from '@zag-js/date-utils';
import { setElementValue, raf, restoreTextSelection, disableTextSelection, queryAll, query, getNativeEvent, dataAttr, ariaAttr, getEventKey, isComposingEvent } from '@zag-js/dom-query';
import { getPlacement, getPlacementStyles } from '@zag-js/popper';
import { createSplitProps, clampValue, chunk, isValueWithinRange, match } from '@zag-js/utils';
import { memo, createGuards, createMachine } from '@zag-js/core';
...
var getVisibleRangeText = memo(
  ...
  ([view], opts) => {
    ...
    if (view === "month") {
      const formatter2 = new DateFormatter(locale, { year: "numeric", timeZone });
