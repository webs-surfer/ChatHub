...
import { TreeCollectionOptions, TreeCollection, TreeNode, IndexPath } from '@zag-js/collection';
...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"root" | "label" | "control" | "trigger" | "indicator" | "valueText" | "clearTrigger" | "positioner" | "content" | "list" | "item" | "itemText" | "itemIndicator">;
declare const parts: Record<"root" | "label" | "control" | "trigger" | "indicator" | "valueText" | "clearTrigger" | "positioner" | "content" | "list" | "item" | "itemText" | "itemIndicator", _zag_js_anatomy.AnatomyPart>;
...
export { type CascadeSelectApi as Api, type ElementIds, type HighlightChangeDetails, type ItemProps, type ItemState, type CascadeSelectMachine as Machine, type OpenChangeDetails, type CascadeSelectProps as Props, type ScrollToIndexDetails, type CascadeSelectService as Service, type ValueChangeDetails, anatomy, collection, connect, machine, parts, props, splitProps };
