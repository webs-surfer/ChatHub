...
const DatePickerWeekNumberHeaderCell = react.forwardRef(
  (props, ref) => {
    ...
    const mergedProps = react$1.mergeProps(datePicker.getWeekNumberHeaderCellProps(tableProps), props);
    return /* @__PURE__ */ jsxRuntime.jsx(factory.ark.th, { ...mergedProps, ref });
  }
);
