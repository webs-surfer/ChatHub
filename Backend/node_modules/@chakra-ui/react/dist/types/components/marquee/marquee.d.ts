...
export interface MarqueeControlProps extends HTMLChakraProps<"div">, UnstyledProp {
}
export declare const MarqueeControl: import("react").ForwardRefExoticComponent<MarqueeControlProps & import("react").RefAttributes<HTMLDivElement>>;
